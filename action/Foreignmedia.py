...
result = rawABC.split("\n") + result = rawAbemaTV.split("\n") + result = rawAll4.split("\n") + result = rawAmazon.split("\n") + result = rawAmazonPrimeVideo.split("\n") + result = rawApple.split("\n") + result = rawAppStore.split("\n") + result = rawAppleMedia.split("\n") + result = rawBBC.split("\n") + result = rawBahamut.split("\n") + result = rawBritboxUK.split("\n") + result = rawCake.split("\n") + result = rawCloudflare.split("\n") + result = rawDAZN.split("\n") + result = rawDeezer.split("\n") + result = rawDiscord.split("\n") + result = rawDisney.split("\n") + result = rawDiscoveryPlus.split("\n") + result = rawDropbox.split("\n") + result = raweBay.split("\n") + result = rawFacebook.split("\n") + result = rawFitnessPlus.split("\n") + result = rawFOXNOW.split("\n") + result = rawfriDay.split("\n") + result = rawFuboTV.split("\n") + result = rawGitHub.split("\n") + result = rawGoogle.split("\n") + result = rawHBO.split("\n") + result = rawHWTV.split("\n") + result = rawHulu.split("\n") + result = rawIMDB.split("\n") + result = rawITV.split("\n") + result = rawInstagram.split("\n") + result = rawiQIYIIntl.split("\n") + result = rawKKBOX.split("\n") + result = rawKKTV.split("\n") + result = rawLiTV.split("\n") + result = rawLine.split("\n") + result = rawLineTV.split("\n") + result = rawMicrosoft.split("\n") + result = rawMicrosoftEdge.split("\n") + result = rawMozilla.split("\n") + result = rawNetflix.split("\n") + result = rawNiconico.split("\n") + result = rawNowE.split("\n") + result = rawOneDrive.split("\n") + result = rawPBS.split("\n") + result = rawPPTV.split("\n") + result = rawPandora.split("\n") + result = rawParamountPlus.split("\n") + result = rawPayPal.split("\n") + result = rawPeacock.split("\n") + result = rawPikPak.split("\n") + result = rawPixiv.split("\n") + result = rawPlayStation.split("\n") + result = rawPotatoChat.split("\n") + result = rawProtonmail.split("\n") + result = rawQobuz.split("\n") + result = rawReddit.split("\n") + result = rawShopee.split("\n") + result = rawSpeedtest.split("\n") + result = rawSpotify.split("\n") + result = rawSteam.split("\n") + result = rawTelegram.split("\n") + result = rawTIDAL.split("\n") + result = rawTikTok.split("\n") + result = rawTumblr.split("\n") + result = rawTVB.split("\n") + result = rawTwitch.split("\n") + result = rawTwitter.split("\n") + result = rawViki.split("\n") + result = rawViuTV.split("\n") + result = rawWeTV.split("\n") + result = rawWhatsapp.split("\n") + result = rawWikipedia.split("\n") + result = rawXbox.split("\n") + result = rawYouTube.split("\n") + result = rawYouTubeMusic.split("\n")

with open("./Foreignmedia.conf", "w") as f:
    f.write("\n".join(result))
